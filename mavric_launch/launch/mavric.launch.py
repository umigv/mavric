...
def generate_launch_description():
    ...
    bno055_params = os.path.join(
        get_package_share_directory("mavric_launch"), "config", "bno055_params.yaml"
    )
    ...
    urdf = os.path.join(
        get_package_share_directory("mavric_launch"), "urdf", "mavric.urdf"
    )
    ...
    return LaunchDescription(
        [rsp, jsp, bno055, velodyne, robot_localization, slam_toolbox]
    )
